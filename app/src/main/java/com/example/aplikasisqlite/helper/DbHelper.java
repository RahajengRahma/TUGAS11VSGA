...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void insert (String name, String adress){
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("INSERT INTO "+TABLE_SQLite+"(name, adress)"+"VALUES ('" + name + "','" + adress + "')");
        db.close();

    }

    public void update (int id, String name, String adress){
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("UPDATE "+ TABLE_SQLite+" SET "+COLUMN_NAME+"='" + name  +"' , "+COLUMN_ADRESS+"='" + adress + "' WHERE "+COLUMN_ID+"='"+id+"'");
        db.close();
    }
